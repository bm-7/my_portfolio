          ...
          children: [
            Column(
              ...
              children: [
                ...
                // Removed SizedBox here to reduce space between the description and email options
                MouseRegion(
                  onEnter: (_) {
                    setState(() {
                      changecolor = true;
                  ...
                  child: Container(
                    ...
                    height:
                    Responsive.isLaptopScreen(context)? 200 : 150,
                    decoration: BoxDecoration(
                      color: Colors.grey.shade800,
                      borderRadius: BorderRadius.circular(
                          Responsive.isLaptopScreen(context)? 25 : 15),
                    ),
                    child: Column(
                        ...
                        ListTile(
                          ...
                          leading: CircleAvatar(
                            ...
                            child: Icon(
                              ...
                              size: Responsive.isLaptopScreen(context)
                                  ? 20
                                  : 12,
                              color: changecolor
                                  ? Colors.black54
                    ...
                    children: [
                      Center(
                        child: Padding(
                          ...
                          child: Container(
                            width:
                            Responsive.isLaptopScreen(context)? 300 : 150,
                            height:
                            Responsive.isLaptopScreen(context)? 400 : 180,
                            color: Colors.amber,
                            child: const Image(
                              fit: BoxFit.cover,
                      ...
                      Positioned(
                        top: Responsive.isLaptopScreen(context)? 200 : 100,
                        left: 0,
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Colors.white,
                            borderRadius: BorderRadius.circular(
                                Responsive.isLaptopScreen(context)? 20 : 10),
                          ),
                          child: Padding(
                            padding: EdgeInsets.all(
                                Responsive.isLaptopScreen(context)? 8 : 3),
                            child: Row(
                      ...
                      Positioned(
                        top: Responsive.isLaptopScreen(context)? 300 : 140,
